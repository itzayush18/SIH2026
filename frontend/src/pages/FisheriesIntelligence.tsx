    ...
    <div className="min-h-screen bg-white font-outfit text-slate-900 flex flex-col">
      <div className="max-w-6xl mx-auto w-full px-6 py-12 flex-grow">
        <div className="mb-8 flex items-center justify-between border-b-2 border-slate-900 pb-6">
          <div>
            <h1 className="text-4xl font-bold tracking-tight mb-2">Fisheries & Border Intelligence</h1>
            <p className="text-slate-500">Detect fishing activity, zone violations & vessel conflicts</p>
          </div>
        ...
        <div className="prose max-w-none mb-12">
          <p className="text-lg text-slate-700 leading-relaxed max-w-4xl">
            Protecting Exclusive Economic Zones (EEZ) requires constant vigilance. The Fisheries & Border Intelligence module ingests VMS and AIS feeds alongside optical imagery to predict conflicts and detect zone violations automatically. By leveraging the OilTrace Core for shared spatial indexing and alerting, border patrols receive real-time, actionable intelligence.
          </p>
        </div>
        ...
        <div className="border-2 border-slate-900 p-6 bg-[#f8fafc] mb-16 shadow-[8px_8px_0px_0px_rgba(15,23,42,1)]">
          ...
          <img src="/arch_fisheries.svg" alt="Fisheries Intelligence Architecture" className="w-full h-auto" />
        </div>
